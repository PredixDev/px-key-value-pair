...
function runBaseTests() {
  px_key_value_pair_1 = document.getElementById('px_key_value_pair_1');

  suite('Base Automation Tests for px-key-value-pair', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-key-value-pair fixture is created', function() {
      assert.isTrue(document.getElementById('px_key_value_pair_1') !== null);
    });
